...
let RegisteredUserHandler = class RegisteredUserHandler {
...
RegisteredUserHandler = __decorate([
    cqrs_1.EventsHandler(registered_user_event_1.RegisteredUserEvent),
    __param(0, common_1.Inject(common_1.forwardRef(() => auth_service_1.AuthService))),
    __metadata("design:paramtypes", [auth_service_1.AuthService])
], RegisteredUserHandler);
exports.RegisteredUserHandler = RegisteredUserHandler;
